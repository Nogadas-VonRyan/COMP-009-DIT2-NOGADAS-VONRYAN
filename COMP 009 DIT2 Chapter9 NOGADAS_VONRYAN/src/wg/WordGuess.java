...
//		loadWords();
	...
	private void validateGuess(char letter) {
		...
		if(!correct) {
			mistakes++;
			JOptionPane.showMessageDialog(null,"Wrong letter! " + mistakes + " mistake/s made.");
		} else {
...
//		//four letter words
//		listOfWords[0] = new String[] {"vain","verb", "vase","ages","able","airy","beak","bile","bone","bath","gang","gowl","gave","unto","user","undo","musk","mare","mess","mood"};
//		//five letter words
//		listOfWords[1] = new String[] {"dated", "debug", "denim", "gappy", "glade", "gnome", "jeeps", "juror", "junta", "leapt", "least", "loads", "zones", "zebra", "zesty", "peeve", "pause", "picky", "porch", "pupil"};
//		// six letter words
//		listOfWords[2] = new String[] {"kneads", "kipper", "kissed", "kitten", "karate", "xylate", "obtain", "onward", "organs", "oxygen", "occult", "office", "rabies", "racket", "rebind", "razing", "redden", "rouged", "rustle", "ribbon"};
//	}
	
	private void loadWordsFromCSV() {
		try(BufferedReader buffer = new BufferedReader(new FileReader("Words.csv"))){
			String firstLine = buffer.readLine();
			String secondLine = buffer.readLine();
			String thirdLine = buffer.readLine();
		
			listOfWords[0] = firstLine.split(",");
			listOfWords[1] = secondLine.split(",");
			listOfWords[2] = thirdLine.split(",");
